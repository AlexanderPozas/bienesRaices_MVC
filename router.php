...
class Router
{
    ...
    public function comprobarRutas()
    {
        ...
        /**Verificar si existe un query string en la url */
        $pos = strpos($urlActual, '?');
        if($pos){
            /**Si existe, se extrae unicamente la url del routing */
            $urlActual = substr($urlActual,0, $pos); //Quita el query string de la url
        }       
